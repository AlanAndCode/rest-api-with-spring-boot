package br.com.api.integrationtests.controller.withjson
...
class PersonControllerJsonTest : AbstractIntegrationTest() {
    ...
    fun testHATEOAS() {
        ...
        assertTrue(content.contains("""_links":{"self":{"href":"http://localhost:8080/api/person/v1/797"}}}"""))
        assertTrue(content.contains("""_links":{"self":{"href":"http://localhost:8080/api/person/v1/686"}}}"""))
        assertTrue(content.contains("""_links":{"self":{"href":"http://localhost:8080/api/person/v1/340"}}}"""))
        ...
        assertTrue(content.contains(""","last":{"href":"http://localhost:8080/api/person/v1?direction=asc&page=83&size=12&sort=firstName,asc"}"""))
